...
<body>
        ...
        $(document).ready(function() {
            ...
            $("#tabs li").click(function() {
                ...
                if(modeEditor) {
                    ...
                    $.get(hostname + "/catalog/getCategoryById", {
                        id: navigationId
                    })
                    .done(function(content) {
                        ...
                        $(".settings form").submit(function(event) {
                            ...
                            $.post(hostname + "/catalog/editCategoryById", {
                                data: data
                            })
                            .done(function(content) {
                    ...
                    // Clic sur un bouton
                    $.get(hostname + "/catalog/getAllCategoriesById", {
                        id : navigationId
                    })
                    .done(function(content) {
                        $("#items").html("");
            ...
            $(document).on('click', 'a.panel-block', function() {
                    ...
                    .done(function(content) {
                        ...
                        $(".settings form").submit(function(event) {
                            ...
                            .done(function(content) {
                                ...
                                elmt.find('span').html($(".settings form #caption").val());
                                elmt.find('img').attr("src", "https://flash.habbomotel.com/c_images/catalogue/icon_" + $(".settings form #icon-image").val() + ".png");
                                console.debug(content);
                            });
                        });
                    });
                ...
                // Mode normal
                    ...
                    if($(this).hasClass("is-active")) {
                        ...
                        $.get(hostname + "/catalog/getAllSubCategoriesById", {
                                id: categoryId
                        })
                        .done(function(content) {
                            if(content == "null") {
                                $.get(hostname + "/catalog/getAllFurnituresById", {
                                    id: categoryId,
                                    caption: caption
                                })
                                .done(function(content) {
                        ...
                        $(".droppable").droppable({
                            ...
                            drop: function(event, ui) {
                                ...
                                if($(this).attr("item-parent") != categoryTarget.attr("category-id")) {
                                    $.get(hostname + "/catalog/saveFurnitureToCategoryId", {
                                        items: itemsToSave
                                    })
                                    .done(function(content) {
                                    });
            ...
            $(document).on("click", "#items div.item", function() {
                ...
                if(modeEditor) {
                    var body = $("body");
                    $.get(hostname + "/catalog/getFurnitureById", {
                        id: itemId
                    })
                    .done(function(content) {
                        $(".settings").css("height", body.css('height')).html(content).show();
                        $(".settings form").submit(function(event) {
                            ...
                            $.post(hostname + "/catalog/editFurnitureById", {
                                data: data
                            })
                            .done(function(content) {
                            });
            ...
            $(".add-category").click(function() {
                ...
                $.get(hostname + "/catalog/addCategory")
                .done(function(content) {
    ...
    @import url('https://www.habbomotel.com/css/bulma-tooltip.min.css');
    @import url('https://www.habbomotel.com/css/bulma-switch.min.css');
