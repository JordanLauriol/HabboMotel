	...
	<div class="container">
		<div class="columns">
			...
			<div class="column">
				<?= $this->Flash->render(); ?>
				<div class="box">
					<p class="title is-6"><?= __("Créer un article"); ?></p>
					...
					<?= $this->Form->control('topstory', [
						'label' => false,
						'templateVars' => [
							'help' => sprintf(__("Selectionner une image parmis celles ce trouvant %s et coller le lien de l'image."), $this->Html->link("https://flash.habbomotel.in/c_images/web_promos/", "https://flash.habbomotel.in/c_images/web_promos/", ['target' => '_blank'])),
							'icon' => 'picture-o',
							'has_icon' => 'has-icons-left'
						]
					]); ?>
					...
					<?= $this->Form->submit(__("Créer l'article"), ['class' => 'button is-success']); ?>
					<?= $this->Form->end(); ?>
				</div>
			</div>
		</div>
